...
**Milestone #3** can be submitted after December 4 until December 14, with a penalty of 10% for each day late. After December 14 2021, the submission process is considered closed.
- submissions received on Dec 05 2021 can receive **max 90%**;
- submissions received on Dec 06 2021 can receive **max 80%**;
- submissions received on Dec 07 2021 can receive **max 70%**;
- submissions received on Dec 08 2021 can receive **max 60%**;
- submissions received on Dec 09 2021 can receive **max 50%**;
- submissions received on Dec 10 2021 can receive **max 40%**;
- submissions received on Dec 11 2021 can receive **max 30%**;
- submissions received on Dec 12 2021 can receive **max 20%**;
- submissions received on Dec 13 2021 can receive **max 10%**;
- submissions received on Dec 14 2021 can receive **max  0%**;
